...
enum e_rknpu_mem_type {
	...
	RKNPU_MEM_MASK = RKNPU_MEM_NON_CONTIGUOUS | RKNPU_MEM_CACHEABLE |
			 ...
			 RKNPU_MEM_IOMMU_LIMIT_IOVA_ALIGNMENT | RKNPU_MEM_ALLOCATED
};
 ...
 * @usr_va: address of the allocated memory if RKNPU_MEM_ALLOCATED is set; 
 * only dma map is performed without setting RKNPU memory object.
