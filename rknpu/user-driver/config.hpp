...
#define NPU_INPUT_BUFFER_SIZE (50 * 1024 * 1024)  // 50MB for input buffers (reduced from 100MB)
#define NPU_OUTPUT_BUFFER_SIZE (200 * 1024 * 1024)  // 200MB for output buffers (reduced from 450MB)
